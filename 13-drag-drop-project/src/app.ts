...
class ProjectState {
  ...
  addProject(title: string, description: string, munOfPeople: number) {
    const newPeople = {
      id: Math.random().toString(),
      title: title,
      description: description,
      munOfPeople: munOfPeople,
    };
...
function validate(validatableInputs: Validatable) {
  ...
  if (validatableInputs.required) {
    isValid = isValid && validatableInputs.value.toString().trim().length !== 0;
  }
...
class ProjectInput {
  ...
  descritionInputElement: HTMLInputElement;
  ...
  constructor() {
    ...
    this.descritionInputElement = this.element.querySelector(
      "#description"
    ) as HTMLInputElement;
  ...
  private gatherUserInput(): [string, string, number] | undefined {
    ...
    const enteredDescription = this.descritionInputElement.value;
  ...
  private cleanInputs() {
    ...
    this.descritionInputElement.value = "";
